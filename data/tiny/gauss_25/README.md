## GAUSS_25 dataset
This is a tiny data set of the first 50 records (10 random hyper-parameter combinations at 5 epochs) from the [complete dataset of 10,000 rows](https://drive.google.com/uc?id=0Bz2L2qpV9PICOVpoTDNzc3NQNlU&export=download)) and for demonstration purpose only.
